    ...
    <main class="main">
        <div class="content">
            ...
            if(isset($_SESSION['status_message'])){
                ...
                echo '<div class="status-notification ' . $status_type . '">' . htmlspecialchars($_SESSION['status_message']) . '</div>';
                        ...
                        <tbody id="itemsTableBody">
                            ...
                            if($result && $result->num_rows > 0){
                                while($row = $result->fetch_assoc()){
                                    ...
                                    echo "<td class='title-cell'>" . htmlspecialchars($row['title']) . "</td>";
