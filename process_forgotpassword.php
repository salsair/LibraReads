...
switch ($action) {
    case 'send_otp':
        ...
        try {
                // Pengaturan SMTP dari Hosting (BARU)
                $mail->isSMTP();
                $mail->Host       = 'librareads.my.id'; 
                $mail->SMTPAuth   = true;
                $mail->Username   = 'support@librareads.my.id';
                $mail->Password   = 'libra999reads';
                $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;
                $mail->Port       = 465;  

            // Penerima dan Pengirim
            $mail->setFrom('support@librareads.my.id', 'LibraReads Support');
            ...
            json_output('error', "Gagal mengirim email. Detail Error: " . $mail->ErrorInfo);
        }
        break;
