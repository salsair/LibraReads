    ...
    <div class="main">
        <header class="top-nav">
             <form action="mybooks.php" method="GET">
                <input type="search" name="search" class="search-bar" placeholder="Find a book on your bookshelf..." value="<?php echo htmlspecialchars($search_query); ?>">
                ...
                <div class="book-list">
                    ...
                    <?php else: ?>
                        <?php if (empty($search_query)): ?>
                            <p class="empty-section-message">You haven't started reading any books yet. Start from <a href="catalog.php">catalog</a>!</p>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            </section>
                    ...
                    <?php if ($total_books_found == 0): ?>
                        <div class="empty-bookshelf">
                            ...
                            <?php if (!empty($search_query)): ?>
                                ...
                                <p>We couldn't find any books matching this "<?php echo htmlspecialchars($search_query); ?>".</p>
                                <a href="mybooks.php" class="btn-primary">Clear Search</a>
                            <?php else: ?>
                                <h3>Your Bookshelf is Empty</h3>
                                <p>Add books from the catalog to see them here.</p>
