...
<body>
    ...
    <main class="reader-main">
        ...
        <div class="pdf-container" id="pdfContainer">
            ...
            <div class="error-container" id="errorContainer">
                ...
                <h2 class="error-title">Could Not Load PDF</h2>
                <p class="error-message">
                    The PDF could not be displayed in the browser. This might be due to CORS restrictions or an unsupported file format.
                </p>
        ...
        <div class="no-content-container">
            ...
            <p>Sorry, the content for this book is not yet available for online reading.</p>
    ...
    <div id="errorModal" class="error-modal">
        <div class="error-content">
            ...
            <p id="errorMessage">An error occurred while loading the book. Please try again.</p>
            <div class="error-actions">
